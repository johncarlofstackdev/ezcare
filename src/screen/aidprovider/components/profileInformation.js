...
import { Box, Text, Heading, VStack, HStack, Center, Pressable, Avatar, Divider } from "native-base";
...
const ProfileInformation = ({ nav }) => {
    ...
    const profileInformationMemoMize = useMemo(() => {
        return (
            <>
                        ...
                        <>
                            ...
                            <Box mt="5">
                                <VStack space={5}>
                                    ...
                                    <HStack space={5} alignItems="center">
                                        <Box>
                                            <FontAwesome5 name="user-tag" size={23} color="#f63b3b" />
                                        </Box>
                                        <Text fontSize="23" color="coolGray.600">
                                            A Professional {data.serviceType == 1 ? "First Aider" : data.serviceType == 2 ? "Police" : "BFP"}
                                        </Text>
                                    </HStack>
                                </VStack>
                            </Box>
    ...
    return profileInformationMemoMize;
}
